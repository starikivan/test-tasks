...
//                (position 0) and wants to get to the opposite bank (position X+1). Leaves fall from a tree onto the
...
//                only when leaves appear at every position across the river from 1 to X (that is, we want to find the
//                earliest moment when all the positions from 1 to X are covered by leaves). You may assume that the speed
//                of the current in the river is negligibly small, i.e. the leaves do not change their positions once they
//                fall in the river.
//
...
public class C_04_FrogRiverOne {
